...
sCONNECTION_STRING = "DRIVER=Microsoft Access Driver (*.mdb);DBQ=D:\inetpub\wwwroot\inc\data\database.mdb;UID=administrator;PWD=password"
'sCONNECTION_STRING = "MyDatabase"
