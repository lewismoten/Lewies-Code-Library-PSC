...
Public Class JournalMonitor
	...
	Protected ServiceProviders() As Services.BaseService
...
#End Region
	...
	Private Sub LoadSettings()
		...
		Dim DataProviderType As Type = System.Type.GetType(DataStore.Type)
		DataProvider = Activator.CreateInstance(DataProviderType)
		DataProvider.DataStore = DataStore

		Dim ServiceProviders(Alerts.Services.Length - 1) As Services.BaseService
		For i As Integer = 0 To Alerts.Services.Length - 1
			Dim Service As Config.Alerts.Service = Alerts.Services(i)
			Dim ServiceType As Type = System.Type.GetType(Service.Type)
			Dim ServiceProvider As Services.BaseService
	...
	Private Sub CheckJournal()
		...
		Else
			...
			JournalText = Common.ReadTextFile(JournalPath, LastLength + 1)
		End If
	...
	Private Sub CheckAlerts()
		...
		For Each ServiceProvider As Services.BaseService In ServiceProviders
