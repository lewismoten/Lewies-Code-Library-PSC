...
## [BitsToNum/NumToBits](./BitsToNumNumToBits)
...
## [Left Shift and Right Shift](./LeftRightShift)
...
## [Convert 16 bit colors to 24 bit](./Color16To24)
...
## [ASP Whois Component with sample code](./WhoisComponent)
...
## [Simple Log Routine](./SimpleLogRoutine)
...
## [Load a Text File](./LoadATextFile)
...
## [Dynamic Intrinsic Controls](./DynamicIntrinsicControls)
...
## [Determine if File Is Old](./FileIsOld)
...
## [Remove Item Confirmation](./RemoveItemConfirmation)
...
## [Embed Binary Files In Programs](./EmbededFiles)
...
## [Text to String Conversion](./TextToStringConversion)
...
## [vbScript Decoder - exe](./vbScriptDecoder)
